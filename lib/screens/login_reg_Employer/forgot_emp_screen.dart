...
import 'package:internshipgate/controllers/forgot_emp_controller.dart';
import 'package:internshipgate/widgets/input_field.dart';
import 'package:internshipgate/widgets/splash_tile.dart';

class EmpForgotPasswordScreen extends StatelessWidget {
  final EmpForgotPasswordController forgotPasswordController =
      Get.put(EmpForgotPasswordController());

  EmpForgotPasswordScreen({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: SubmitButton(
                    onPressed: () {
                      forgotPasswordController.sendEmpPasswordResetEmail();
                    },
