...
class EmployeeIntern extends StatefulWidget {
  final int recId;
  ...
  @override
  State<EmployeeIntern> createState() => _EmployeeInternState();
}

class _EmployeeInternState extends State<EmployeeIntern> {
  ...
  List<String> selectedInternshipTypes = [];
  ...
  postint(String employerId, email, companyname, industryType, internshipDetails, location, totalOpening, type, duration1, duration2, startdate, jobDescription, stipendType, compensation1, compensation2, perks, skill) async {
    try{
      showDialog(
        context: context,
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(fontSize: width * 0.035, fontWeight: FontWeight.bold),
                        ),
                      ),
                    ),
                    SizedBox(height: height * 0.03,),
                    ...
                    SizedBox(
                      ...
                      child: CheckboxListTile(
                        ...
                        value: selectedInternshipTypes.contains(
                            'work from home'),
                        onChanged: (value) {
