...
class InternshipDetailPage extends StatefulWidget {
  ...
  final int studentId;
  final Function(int, int) applyForInternshipCallback;
  ...
  const InternshipDetailPage(
      ...
      required this.applyForInternshipCallback,
...
class _InternshipDetailPageState extends State<InternshipDetailPage> {
  ...
  Future<InternshipDetail> fetchInternshipDetail() async {
    final response = await http.get(
      Uri.parse(
          '${ApiEndPoints.baseUrl}getEmployerInternshipDetailsById/${widget.internshipId}'),
    );
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    // Add some space between the start date and stipend type
                    const Text(
                      'Stipend Type:',
                      style:
                          TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                    ...
                    const SizedBox(height: 8),
                    // Add some space between the stipend type and compensation
                    const Text(
                      'Compensation:',
                      style:
                          TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                    ...
                    const SizedBox(height: 8),
                    // Add some space between the compensation and perks
                    const Text(
                      'Perks:',
                      style:
                          TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                    ...
                    const SizedBox(height: 8),
                    // Add some space between the perks and skill
                    const Text(
                      'Skill:',
                      style:
                          TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          if (widget.complete_profile) {
                            ...
                            widget.applyForInternshipCallback(
                              widget.internshipId, widget.studentId);
                          }
                        },
                        child: const Text(
                          'Apply Now',
