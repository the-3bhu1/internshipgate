...
class _TrainingFormState extends State<TrainingForm> {
  ...
  final TextEditingController _traDescriptionController = TextEditingController();
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        if (responseData['status'] == 1) {
          Get.snackbar(
            'Success',
            'Training details added/updated successfully!',
            snackPosition: SnackPosition.BOTTOM,
          );
            widget.refreshCallback.call();
             Navigator.pop(context);
          
          print("Training details added/updated successfully!");
          print(responseData);
        } else {
          print(
              "Failed to add/update training details. ${responseData['message']}");
        }
      } else {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // TextFormField(
                  //   controller: _traOrgNameController,
