...
class EditInternshipForm extends StatefulWidget {
  var applicantId,
      internshipId,
      int_start_date,
      int_end_date,
  ...
  EditInternshipForm({
    ...
    required this.int_profile,
    required this.int_org_name,
    required this.int_location,
    required this.int_start_date,
    required this.int_end_date,
    required this.int_current_status,
    required this.int_description,
  }) : super(key: key);

  @override
  State<EditInternshipForm> createState() => _EditInternshipFormState();
}

class _EditInternshipFormState extends State<EditInternshipForm> {
  ...
  final TextEditingController _intDescriptionController = TextEditingController();
  ...
  void initState() {
    super.initState();
    cities();
    _intProfileController.text = widget.int_profile;
    _intOrgNameController.text = widget.int_org_name;
   
    _intStartDateController.text = widget.int_start_date;
    _intEndDateController.text = widget.int_current_status == "Currently working here" ? " " : widget.int_end_date;
    _isCurrentlyWorking = widget.int_current_status == "Currently working here";
    _intDescriptionController.text = widget.int_description;
    selectedCity = widget.int_location.toString();
  }

  String selectedCity='';
  Future<void> _submitForm(String selectedCity) async {
    const apiUrl =
        '${ApiEndPoints.baseUrl}updateApplicantInternship';
    ...
    final response = await http.post(
      ...
      body: jsonEncode({
        ...
        "int_end_date": _isCurrentlyWorking ? null : _intEndDateController.text,
        "int_current_status": _isCurrentlyWorking ? "Currently working here" : "NO",
  ...
  Future<void> cities() async {
    try {
      final response = await get(
        Uri.parse(
            '${ApiEndPoints.baseUrl}getLocationMasterDetails'),
      );
