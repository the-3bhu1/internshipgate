...
class EditProjectDetailsPage extends StatefulWidget {
  var applicantId,projectId,prj_start_date,prj_end_date,prj_current_status,
   email,prj_profile,prj_org_name,prj_location,prj_description;
  ...
  EditProjectDetailsPage({
    ...
    required this.prj_profile,
    required this.prj_org_name,
    required this.prj_location,
    required this.prj_start_date,
    required this.prj_end_date,
    required this.prj_current_status,
    required this.prj_description,
  });
...
class _EditProjectDetailsPageState extends State<EditProjectDetailsPage> {
  ...
  final TextEditingController _prjDescriptionController = TextEditingController();
...
@override
  void initState() {
    ...
    _prjProfileController.text = widget.prj_profile;
    _prjOrgNameController.text = widget.prj_org_name;
    _prjLocationController.text = widget.prj_location;
    _prjStartDateController.text = widget.prj_start_date;
    _prjEndDateController.text =
        widget.prj_current_status == "YES" ? "" : widget.prj_end_date;
    _isCurrentlyWorking = widget.prj_current_status == "YES";
    _prjDescriptionController.text = widget.prj_description;
  }
