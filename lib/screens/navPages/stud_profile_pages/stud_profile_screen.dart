...
// }
  ...
  Future<void> fetchInternship(String applicantId) async {
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        final Map<String, dynamic> data = json.decode(response.body);
        print(data['applicant_internship']);
          final dynamic applicantInternship = data['applicant_internship'];
          print(applicantInternship);
        if (data.isNotEmpty) {
                        ...
                        TextButton(
                          onPressed: () async {
                            if (_formKey.currentState!.validate()) {
                              await updateStudentProfile(selectedScale, selectedCities);
                              setState(() {
                                _isEditing = false;
                              });
                            }
...
// import 'package:ig/buttons/add_education_button.dart';
// import 'package:ig/buttons/edit_button.dart';


// import 'package:ig/screens/navPages/stud_profile_pages/Edit_screen.dart';

// import 'package:ig/screens/navPages/stud_profile_pages/add_internshipdetails.dart';
// import 'package:ig/screens/navPages/stud_profile_pages/add_project.dart';
// import 'package:ig/screens/navPages/stud_profile_pages/add_trainingdetails.dart';
// import 'package:ig/screens/navPages/stud_profile_pages/edit_internship.dart';
// import 'package:ig/screens/navPages/stud_profile_pages/edit_project.dart';
// import 'package:ig/screens/navPages/stud_profile_pages/edit_training.dart';

// import 'package:ig/widgets/input_field.dart';
// import 'package:image_picker/image_picker.dart';
...
//         studentId: studentId,
//         applicantId: applicantId,
//         emai: emai, fullname: fullname, emptoken: emptoken,
//       ),
//     );
//   }
// }
...
//   @override
//   _StudentProfilePageContentState createState() =>
//       _StudentProfilePageContentState();
// }
...
//   String _savedAddress = "";
//   String _savedExperience = "";
//   List<dynamic> _savedSkills = [];

//   List<dynamic> _educationDetails = [];
//   List<dynamic> _internshipDetails = [];
//   List<dynamic> _projectDetails = [];
//   List<dynamic> _trainingDetails = [];
//   File? _imageFile;
//   String _pic = '';

//   List<Map<String, String>> skills = [];
//   List<String> selectedSkills = [];
//   String _applicantBasicDetailId = "";
...
//   //   final Uri updateUri = Uri.parse(
//   //       'https://staging-dev.internshipgate.com/public/api/updateApplicantPictureById');
//   //   final response = await http.post(
//   //     updateUri,
//   //     body: jsonEncode({
//   //       'pic': _pic,
...
//     try {
//       final response = await http.get(Uri.parse(
//           'https://staging-dev.internshipgate.com/public/api/getApplicantProfileById/$applicantId'));
...
//             _nameController.text = basicDetail['name'] ?? "";
//             _mobileController.text = mobileno['mobileno'] ?? "";
//             _locationController.text = basicDetail['location'] ?? "";
//             _addressController.text = basicDetail['address'] ?? "";
//             _experienceController.text = basicDetail['exp_year'] ?? "";
//             _expMonthController.text = basicDetail['exp_month'] ?? "";
//             _emailController.text = basicDetail['email'] ?? "";
...
//             _savedLocation = " ${basicDetail['location']}";
//             _savedAddress = " ${basicDetail['address']}";
//             _savedExperience = " ${basicDetail['exp_year']} Year "
//                 "${basicDetail['exp_month']} Months";
//           });
//         } else {
//           print("Empty response or unexpected data format");
//         }
...
//             for (var project in projectList) {
//               if (project['applicant_basic_detail_id'] != null) {
//                 _applicantBasicDetailId =
//                     project['applicant_basic_detail_id'].toString();
//                 break;
//               }
//             }
...
//               if (internship['applicant_basic_detail_id'] != null) {
//                 _applicantBasicDetailId =
//                     internship['applicant_basic_detail_id'].toString();
//                 break;
//               }
//             }
...
//               if (education['applicant_basic_detail_id'] != null) {
//                 _applicantBasicDetailId =
//                     education['applicant_basic_detail_id'].toString();
//                 break;
//               }
//             }
//             _educationDetails.clear();
...
//       final response = await get(
//         Uri.parse(
//             'https://staging-dev.internshipgate.com/public/api/getSoftwareSkill'),
//       );
//       if (response.statusCode == 200) {
//         var data = jsonDecode(response.body.toString());
//         //print(data);
...
//       final response = await http.post(
//         Uri.parse(
//             'https://staging-dev.internshipgate.com/public/api/updateApplicantBasicDetail'),
//         headers: {
//           'Content-Type': 'application/json',
//         },
//         body: json.encode({
...
//       }
//     } catch (error) {
//       print('Error updating applicant details: $error');
//     }
//   }
...
//       final response = await http.post(
//         Uri.parse(
//             'https://staging-dev.internshipgate.com/public/api/updateApplicantSoftwareSkill'),
//         headers: {
//           'Content-Type': 'application/json',
//         },
//         body: json.encode({
//           'applicantId': widget.applicantId,
//           'software_skill': selectedSkills
//               .toString(), // Assuming selectedSkills is a List<String>
//           'email': _emailController.text,
//         }),
//       );
...
//         final response = await http.delete(
//           Uri.parse(
//               'https://staging-dev.internshipgate.com/public/api/deleteApplicantEducationById/$educationId'),
//         );
...
//         final response = await http.delete(
//           Uri.parse(
//               'https://staging-dev.internshipgate.com/public/api/deleteApplicantProjectById/$ProjectId'),
//         );
...
//         final response = await http.delete(
//           Uri.parse(
//               'https://staging-dev.internshipgate.com/public/api/deleteApplicantInternshipById/$internshipId'),
//         );

//         if (response.statusCode == 200 || response.statusCode == 201) {
//           ("inetrnship delete check");
//           // Show a Snackbar after successful deletion
//           // ScaffoldMessenger.of(context).showSnackBar(
//           //   const SnackBar(
//           //     content: Text('Project Details Deleted Successfully'),
...
//         final response = await http.delete(
//           Uri.parse(
//               'https://staging-dev.internshipgate.com/public/api/deleteApplicantTrainingById/$trainingId'),
//         );
...
//             children: [
//               Text(
//                 "${education['edu_type']} - ${education['degree']}",
//                 style:
//                     const TextStyle(fontWeight: FontWeight.bold, fontSize: 18),
//               ),
//               //  const SizedBox(width: 20,),
...
//           ),
//           Text(
//             "Performance: ${education['performance_scale']} - ${education['cgpa'] ?? 'N/A'}",
//             style: const TextStyle(fontSize: 18),
//           ),
//           const SizedBox(height: 10),
//         ],
